<h1 align="center"> Welcome to my profile, devs!  👨‍💻 </h1>
...
<h2> What I'm learning or exploring  📝 </h2>
  <ul>
    <li> Basic eletronics </li>
    <li> Introduction to embedded systems/ IoT/ robotics </li>
    <li> Arduino </li>
    <li> C </li>
    <li> RESTful API </li>
    ...
    <li> Python </li>
    <li> HTML5 and semantics </li>
    <li> CSS3 </li>
    <li> JavaScript </li>
    <li> Computer architecture </li>
    <li> Number systems (dec, hex, bin) </li>
